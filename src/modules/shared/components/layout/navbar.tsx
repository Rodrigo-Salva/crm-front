    ...
    <header className="h-16 bg-white border-b border-[var(--border)] flex items-center justify-between px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl border border-[var(--border)] shadow-lg py-1 animate-fade-in z-50">
              <div className="px-4 py-3 border-b border-[var(--border)]">
                <p className="text-sm font-medium text-[var(--text)]">Usuario</p>
                <p className="text-xs text-[var(--text-muted)]">usuario@ejemplo.com</p>
              </div>
              <Link
                href="/settings"
                className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-[var(--sidebar-hover)] transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-[var(--sidebar-hover)] transition-colors"
              >
                <svg className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
