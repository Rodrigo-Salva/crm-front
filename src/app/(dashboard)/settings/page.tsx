...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Comisiones', desc: 'Tasas de comisión y pagos a vendedores', icon: 'M12 8c-1.657 0-3 .672-3 1.5S10.343 11 12 11s3 .672 3 1.5-1.343 1.5-3 1.5m0-6c1.11 0 2.08.402 2.599 1M12 8V6.5M12 8v.5m0 6.5v1.5m0-1.5c-1.11 0-2.08-.402-2.599-1M12 21a9 9 0 100-18 9 9 0 000 18z', color: 'text-yellow-400', bg: 'bg-yellow-500/10 border-yellow-500/20', path: '/settings/commissions' },
      { label: 'Referidos', desc: 'Recompensas por clientes que refieren nuevos leads', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z', color: 'text-teal-400', bg: 'bg-teal-500/10 border-teal-500/20', path: '/settings/referrals' },
      { label: 'Facturación electrónica', desc: 'Timbrado de comprobantes SUNAT vía Nubefact', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', color: 'text-orange-400', bg: 'bg-orange-500/10 border-orange-500/20', path: '/settings/invoicing' },
      ...
      <div className="space-y-8">
        {sections.map((section) => (
          <div key={section.title}>
            <h2 className="text-sm font-semibold text-[var(--text-secondary)] uppercase tracking-wider mb-3">{section.title}</h2>
